...
## inference_server 서비스 3종 (이번에 DaolVision에도 복제됨)
...
| Wan2.2-Animate-14B | :8600 | `inference_server/animate_server.py` | `inference_server/deploy/wan-animate.service` | 미사용(LangGraph가 안 씀, STATE.md 3.6 참고) |

deploy unit 3종은 `WorkingDirectory`/`ExecStart`를 `/home/admin/DaolVision/inference_server`로
