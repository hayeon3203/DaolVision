...
| 4.5 | 스타일 셀렉터 프롬프트 프리픽스 주입 (시네마틱/애니/사이버펑크/로우폴리3D/클레이메이션/수채화) [tdd:required] | style→프리픽스 매핑 함수, 유닛테스트 6종 검증 | cd langgraph && ./.venv/bin/python tests/test_style_prefix.py | - | cc:완료 | - |
